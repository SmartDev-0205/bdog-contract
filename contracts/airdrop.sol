...
contract Airdrop is Claimable {
    ...
    function airdrop(uint256 _amount) public{
        require(approveToken.balanceOf(msg.sender)>0,"You should be token holder");
        require(token.transfer(msg.sender, _amount), "airdrop failed");
    }
